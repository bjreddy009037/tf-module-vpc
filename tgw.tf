...
resource "aws_ec2_transit_gateway_route_table_association" "component-vpc-rt-ass" {
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.component-attach.id
  transit_gateway_route_table_id = data.terraform_remote_state.tgw.outputs.APP_VPC_TRANSIT_GW_RT_TABLE
}
